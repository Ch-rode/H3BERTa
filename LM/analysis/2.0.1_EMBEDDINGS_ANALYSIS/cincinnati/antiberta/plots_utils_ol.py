...
def plot_pca_overview(df, file_suffix="output"):
    # ──────────────────── pulizia preliminare ────────────────────
    for col in ['v_gene', 'j_gene', 'd_gene']:
...
def compute_multiple_ldas(df, embedding_col='embeddings', target_cols=['v_gene', 'j_gene', 'd_gene'], n_components=2):
    """
